...
import { resolveAppAlias } from "./app-aliases";
...
export async function resolveTarget(
  ...
  const lookup = lookupLearned ?? (await import("./database")).getLearnedActionByInput;
...
export async function saveAndConfirm(
  ...
  const { createLearnedAction } = await import("./database");
