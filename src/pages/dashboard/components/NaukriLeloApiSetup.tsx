  ...
  return (
    <div id="api-setup" className="space-y-3 -mt-2 pt-2">
      <Header
        ...
        description="Configure your own AI and STT providers using the Providers page. Supports OpenAI, Anthropic, Gemini, Groq, Ollama and any OpenAI-compatible endpoint."
      />
