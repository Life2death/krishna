...
pub fn run() {
    ...
    let builder = builder
        .invoke_handler(tauri::generate_handler![
            ...
            mobile_bridge::android_open_youtube_music,
            mobile_bridge::android_click_button,
            mobile_bridge::android_open_a11y_settings,
            mobile_bridge::android_hands_free_start,
            mobile_bridge::android_hands_free_stop,
            mobile_bridge::android_get_wake_word_profile,
            mobile_bridge::android_update_wake_word_field,
            mobile_bridge::android_reset_wake_word_profile,
            mobile_bridge::android_get_wake_word_detector_state,
    ...
    app.run(|_app_handle, event| {
        match event {
            ...
            tauri::RunEvent::Exit => {
                // Phase 0: no brain process to clean up.
            }
            _ => {}
        }
    });
