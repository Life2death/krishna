...
### P0-F1 · BLOCKER · FIXED (p1 commit pending) — audio timings are never persisted
...
### P0-F2 · BUG · FIXED (p1 commit pending) — error path repurposes `detail`, losing failure text
...
### P0-F4 · NIT · FIXED (p1 commit pending) — small cleanups
